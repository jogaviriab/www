...
<div class="container mt-5">
    ...
    <div class="enlaces">
        <h2>Enlaces</h2>
        <ul>
            <li><a href="cliente/cliente.php">Entidad análoga a MECÁNICO (PILOTO)</a></li>
            <li><a href="empresa/empresa.php">Entidad análoga a DEPARTAMENTO (ESCUDERÍA)</a></li>
            <li><a href="proyecto/proyecto.php">Entidad análoga a REPARACIÓN (PRUEBA)</a></li>
